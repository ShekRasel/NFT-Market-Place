    ...
    <div className=' text-white pt-24 md:pt-44 px-4 md:px-10 xl:px-24 2xl:px-80'>
        <div className='lg:flex justify-between  '>
            <div className=' '>
                ...
                <div className='text-sm font-semibold  md:text-xl lg:text-base xl:text-xl md:py-5 py-2 lg:py-2 text-slate-300 mt-8 md:mt-10'>
                ...
                <div className='flex justify-between md:justify-start md:gap-8 py-5'>
                    <button className='flex items-center gap-3 py-3 px-4  md:px-8  rounded-md md:font-bold md:text-xl text-white bg-indigo-600 hover:bg-indigo-700'>
                    Explore Now
                    </button>
                    <button className='flex items-center gap-3 py-3  px-4 border-2 rounded-md md:font-bold md:text-xl text-white hover:bg-indigo-700 hover:border-indigo-700'>
                    Upload Your Art
                    </button>
                </div>
            </div>
